...
df_t2d <- allcategroy_df[allcategroy_df$Trait_ontology == "type 2 diabetes mellitus",]

sprintf("ACAT p-values for T2D = %s", round(ACAT(as.numeric(df_t2d$P_value)),digits = 4))
